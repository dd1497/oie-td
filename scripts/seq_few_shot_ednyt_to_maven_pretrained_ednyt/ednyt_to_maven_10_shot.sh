...
SEED=$1
NAME="roberta_ti_pretrained_ednyt_sequential_train_on_maven_10_shot_predict_on_maven_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
LOAD_PRETRAINED_MODEL_FROM="../../models_seed_${SEED}/ednyt_trigger_model"
