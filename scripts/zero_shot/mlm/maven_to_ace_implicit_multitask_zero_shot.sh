...
SEED=$1
NAME="roberta_ti_mlm_train_on_maven_implicit_multitask_zero_shot_predict_on_ace_grid_search_SEED=${SEED}"
LABEL_HIDDEN_SIZES=(10 50 100 300)
DEVICE="cuda:0"
SAVE_TO="../../../models_seed_${SEED}/maven_implicit_multitask_ace_mlm_model_grid_search"
MLM_CHUNK_SIZE=128
MLM_PROBA=0.15
