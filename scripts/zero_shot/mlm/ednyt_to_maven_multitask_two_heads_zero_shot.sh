...
SEED=$1
NAME="roberta_ti_rl_mlm_train_on_ednyt_multitask_two_heads_zero_shot_predict_on_maven_SEED=${SEED}"
DEVICE="cuda:0"
SAVE_TO="../../../models_seed_${SEED}/ednyt_multitask_maven_mlm_model_two_heads"
MLM_CHUNK_SIZE=128
MLM_PROBA=0.15
