...
DATASET_TO_ZERO_SHOT_EVALUATE_ON="EDNYT"
...
DATASET_VALID_TO_EVALUATE_ON_PATH="../../../data/processed/ednyt/valid.json"
DATASET_TEST_TO_EVALUATE_ON_PATH="../../../data/processed/ednyt/test.json"
DATASET_TEST_MINI_EXTRACTIONS_RELATION_TO_EVALUATE_ON_PATH="../../../data/processed/mini/ednyt_test_triplets_filtered_merged.json"
EPOCHS=10
MULTIPLICATIVE_LR=0.99
BATCH_SIZE=32
TRAINING_TASK="trigger identification"
SEED=$1
NAME="roberta_ti_mlm_train_on_maven_implicit_multitask_zero_shot_mlm_validation_predict_on_ednyt_grid_search_SEED=${SEED}"
LABEL_HIDDEN_SIZES=(10 50 100 300)
DEVICE="cuda:0"
SAVE_TO="../../../models_seed_${SEED}/maven_implicit_multitask_ednyt_mlm_validation_model_grid_search"
MLM_CHUNK_SIZE=128
MLM_PROBA=0.15

python ../../../baselines/mlm_validation/ti_rl_mlm_implicit_multitask_grid_search_training_zero_shot_target_evaluation.py \
	--lr $LR \
