...
SEED=$1
NAME="roberta_ti_rl_mlm_train_on_maven_multitask_two_heads_zero_shot_mlm_validation_predict_on_ednyt_SEED=${SEED}"
DEVICE="cuda:0"
SAVE_TO="../../../models_seed_${SEED}/maven_multitask_ednyt_mlm_validation_model_two_heads"
MLM_CHUNK_SIZE=128
MLM_PROBA=0.15
