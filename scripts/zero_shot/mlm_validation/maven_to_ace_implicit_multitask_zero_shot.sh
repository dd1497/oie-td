...
DATASET_TEST_MINI_EXTRACTIONS_RELATION_TO_EVALUATE_ON_PATH="../../../data/processed/mini/ace_test_triplets_filtered_merged.json"
EPOCHS=10
MULTIPLICATIVE_LR=0.99
BATCH_SIZE=32
TRAINING_TASK="trigger identification"
SEED=$1
NAME="roberta_ti_train_on_maven_implicit_multitask_zero_shot_mlm_validation_predict_on_ace_grid_search_SEED=${SEED}"
LABEL_HIDDEN_SIZES=(10 50 100 300)
DEVICE="cuda:0"
SAVE_TO="../../../models_seed_${SEED}/maven_implicit_multitask_ace_mlm_validation_model_grid_search"
MLM_CHUNK_SIZE=128
MLM_PROBA=0.15
