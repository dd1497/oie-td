...
DATASET_TARGET_MINI_EXTRACTIONS_PATH="../../data/processed/mini/ace_test_triplets_filtered_merged.json"
BATCH_SIZE=32
TRAINING_TASK="trigger identification"
SEED=$1
NAME="roberta_ti_implicit_multitask_no_pretrained_zero_shot_predict_on_ace_SEED=${SEED}"
DEVICE="cuda:0"
