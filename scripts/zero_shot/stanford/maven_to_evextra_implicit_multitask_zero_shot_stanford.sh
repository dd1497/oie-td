...
DATASET_TARGET_MINI_EXTRACTIONS_PATH="../../../data/processed/stanford/evextra_test_triplets_filtered_merged.json"
BATCH_SIZE=32
TRAINING_TASK="trigger identification"
SEED=$1
NAME="STANFORD_roberta_ti_implicit_multitask_pretrained_maven_zero_shot_predict_on_evextra_SEED=${SEED}"
DEVICE="cuda:0"
