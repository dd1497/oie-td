...
DATASET_TARGET_TO_EVALUATE_ON_PATH="../../../data/raw/ace/test.json"
DATASET_TARGET_MINI_EXTRACTIONS_PATH="../../../data/processed/stanford/ace_test_triplets_filtered_merged.json"
BATCH_SIZE=32
TRAINING_TASK="trigger identification"
SEED=$1
NAME="STANFORD_roberta_ti_implicit_multitask_no_pretrained_zero_shot_predict_on_ace_SEED=${SEED}"
DEVICE="cuda:0"
