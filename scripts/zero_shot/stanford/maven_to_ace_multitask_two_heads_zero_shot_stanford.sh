...
SEED=$1
NAME="STANFORD_roberta_ti_rl_train_on_maven_multitask_two_heads_zero_shot_predict_on_ace_SEED=${SEED}"
DEVICE="cuda:0"
SAVE_TO="../../../models_seed_${SEED}/maven_multitask_model_two_heads_STANFORD"
