...
SEED=$1
NAME="roberta_ti_rl_train_on_evextra_multitask_two_heads_zero_shot_predict_on_maven_SEED=${SEED}"
DEVICE="cuda:0"
SAVE_TO="../../models_seed_${SEED}/evextra_multitask_model_two_heads"
