...
SEED=$1
NAME="roberta_ti_train_on_ace_implicit_multitask_zero_shot_predict_on_maven_grid_search_SEED=${SEED}"
LABEL_HIDDEN_SIZES=(10 50 100 300)
DEVICE="cuda:0"
SAVE_TO="../../models_seed_${SEED}/ace_implicit_multitask_model_grid_search"
