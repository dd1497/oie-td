...
DATASET_TO_FEW_SHOT_EVALUATE_ON="ACE2005"
...
SEED=$1
NAME="roberta_ti_pretrained_maven_joint_train_on_maven_10_shot_two_heads_multitask_predict_on_ace_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
