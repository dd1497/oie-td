...
SEED=$1
NAME="roberta_ti_mlm_no_pretrained_sequential_train_on_evextra_10_shot_two_heads_multitask_predict_on_evextra_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
LOAD_PRETRAINED_MODEL_FROM=$MODEL
MLM_CHUNK_SIZE=128
MLM_PROBA=0.15

python ../../../baselines/mlm/ti_rl_mlm_sequential_multitask_two_heads_training_few_shot_target_evaluation.py \
	--lr $LR \
	--model "$MODEL" \
