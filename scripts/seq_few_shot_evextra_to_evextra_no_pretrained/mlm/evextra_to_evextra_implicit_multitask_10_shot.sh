...
SEED=$1
NAME="roberta_ti_mlm_no_pretrained_sequential_train_on_evextra_10_shot_implicit_multitask_predict_on_evextra_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
...
python ../../../baselines/mlm/ti_rl_mlm_sequential_implicit_multitask_training_few_shot_target_evaluation.py \
	--lr $LR \
	--model "$MODEL" \
