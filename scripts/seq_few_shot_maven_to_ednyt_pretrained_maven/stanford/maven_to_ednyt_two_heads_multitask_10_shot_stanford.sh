...
DATASET_TRAIN_MINI_EXTRACTIONS_FEW_SHOT_PATH="../../../data/processed/stanford/ednyt_train_triplets_filtered_merged.json"
DATASET_TEST_MINI_EXTRACTIONS_FEW_SHOT_PATH="../../../data/processed/stanford/ednyt_test_triplets_filtered_merged.json"
EPOCHS=10
...
SEED=$1
NAME="STANFORD_roberta_ti_pretrained_maven_sequential_train_on_ednyt_10_shot_two_heads_multitask_predict_on_ednyt_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
