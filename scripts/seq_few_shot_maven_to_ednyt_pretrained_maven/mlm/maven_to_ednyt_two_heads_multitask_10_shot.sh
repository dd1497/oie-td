...
SEED=$1
NAME="roberta_ti_mlm_pretrained_maven_sequential_train_on_ednyt_10_shot_two_heads_multitask_predict_on_ednyt_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
LOAD_PRETRAINED_MODEL_FROM="../../../models_seed_${SEED}/maven_multitask_ednyt_mlm_model_two_heads"
