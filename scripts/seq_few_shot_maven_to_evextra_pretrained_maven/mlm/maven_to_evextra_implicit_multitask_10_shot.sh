...
DATASET_TO_TRAIN_AND_FEW_SHOT_EVALUATE_ON="EVEXTRA"
DATASET_TRAIN_FEW_SHOT_PATH="../../../data/processed/evextra/train.json"
DATASET_TEST_FEW_SHOT_PATH="../../../data/processed/evextra/test.json"
DATASET_TRAIN_MINI_EXTRACTIONS_FEW_SHOT_PATH="../../../data/processed/mini/evextra_train_triplets_filtered_merged.json"
DATASET_TEST_MINI_EXTRACTIONS_FEW_SHOT_PATH="../../../data/processed/mini/evextra_test_triplets_filtered_merged.json"
EPOCHS=10
MULTIPLICATIVE_LR=0.99
BATCH_SIZE=32
BATCH_SIZE_FEW_SHOT=5
AVERAGE_OVER_RUNS_NUM=5
FEW_SHOT_EXAMPLES_NUM=10
TRAINING_TASK="trigger identification"
SEED=$1
NAME="roberta_ti_mlm_pretrained_maven_sequential_train_on_evextra_10_shot_implicit_multitask_predict_on_evextra_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
LOAD_PRETRAINED_MODEL_FROM="../../../models_seed_${SEED}/maven_implicit_multitask_evextra_mlm_model_grid_search"
LABEL_HIDDEN_SIZE=$2
