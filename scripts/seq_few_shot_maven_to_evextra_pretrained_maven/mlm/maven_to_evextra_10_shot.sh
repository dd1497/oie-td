...
SEED=$1
NAME="roberta_ti_mlm_pretrained_maven_sequential_train_on_evextra_10_shot_predict_on_evextra_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
LOAD_PRETRAINED_MODEL_FROM="../../../models_seed_${SEED}/maven_trigger_evextra_mlm_model"
