...
MODEL="roberta-base"
DO_LOWER_CASE=False
DATASET_THE_MODEL_WAS_PRETRAINED_ON="EVEXTRA"
...
SEED=$1
NAME="roberta_ti_pretrained_evextra_sequential_train_on_maven_10_shot_implicit_multitask_predict_on_maven_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
LOAD_PRETRAINED_MODEL_FROM="../../models_seed_${SEED}/evextra_implicit_multitask_model_grid_search"
