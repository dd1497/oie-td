...
DATASET_TRAIN_MINI_EXTRACTIONS_FEW_SHOT_PATH="../../../data/processed/mini/ace_train_triplets_filtered_merged.json"
DATASET_TEST_MINI_EXTRACTIONS_FEW_SHOT_PATH="../../../data/processed/mini/ace_test_triplets_filtered_merged.json"
EPOCHS=10
...
SEED=$1
NAME="roberta_ti_mlm_no_pretrained_sequential_train_on_ace_10_shot_two_heads_multitask_predict_on_ace_average_over_5_runs_SEED=${SEED}"
DEVICE="cuda:0"
