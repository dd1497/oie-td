...
parser = argparse.ArgumentParser(
    description="Runs trigger and relation sequence labeling training on source dataset with MLM and inference on target"
)
...
def train(
    ...
    for i in tqdm(range(epochs)):
        ...
        (
            train_all_metrics_trigger,
            train_all_metrics_relation,
            train_perp,
        ) = logging_multitask(
            model=model,
            loader=loader_train,
        ...
        (
            valid_all_metrics_trigger,
            valid_all_metrics_relation,
            valid_perp,
        ) = logging_multitask(
            model=model,
            loader=loader_valid,
