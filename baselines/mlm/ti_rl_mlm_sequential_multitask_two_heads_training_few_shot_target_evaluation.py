...
parser = argparse.ArgumentParser(
    description="Runs few-shot trigger and relation (with target instances) sequence labeling wit MLM training on a pretrained (source) multitask model and evaluates on target"
)
