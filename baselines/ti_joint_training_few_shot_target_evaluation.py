...
parser = argparse.ArgumentParser(
    description="Runs few-shot trigger sequence labeling training on source dataset with inference on target"
)
...
if __name__ == "__main__":
    ...
    sample_indices = [
        i for i, x in enumerate(few_shot_train) if label2id["B-Trigger"] in x["labels"]
    ]
    x_shot_samples = []
