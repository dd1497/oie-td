...
parser = argparse.ArgumentParser(
    description="Runs few-shot (with target instances) trigger sequence labeling training on a pretrained model (source) and evaluates on target"
)
...
def train_evaluate(
    ...
    print("test_all_metrics_few_shot", configuration_string, all_metrics_few_shot_test)
